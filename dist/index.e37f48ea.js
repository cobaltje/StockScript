...
var _supabaseJs = require("./supabase.js");
var _modelJs = require("./model.js");
var _productListViewJs = require("./views/productListView.js");
var _productListViewJsDefault = parcelHelpers.interopDefault(_productListViewJs);
const productListResults = async function() {
    try {
        ...
        (0, _productListViewJsDefault.default).render(datatest);
    } catch (error) {
        console.error(`💥${error}`);
    }
};
...
},{"./supabase.js":"hCZEc","./model.js":"Y4A21","./views/productListView.js":"knogC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hCZEc":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "supabase", ()=>supabase);
var _supabaseJs = require("@supabase/supabase-js");
const SUPABASE_URL = "https://cfaayqrkolakqvzyqruj.supabase.co";
const SUPABASE_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImNmYWF5cXJrb2xha3F2enlxcnVqIiwicm9sZSI6ImFub24iLCJpYXQiOjE2NzU1ODA4NzcsImV4cCI6MTk5MTE1Njg3N30.q-M6k-4Q8oj3AuFdskkkax_LnfmYlo8LEHgbXJz2bBo";
...
const resolveFetch = (customFetch)=>{
    ...
    if (customFetch) _fetch = customFetch;
            ...
            return yield (yield require("6148091958f44961")).fetch(...args);
        });
    else _fetch = fetch;
    return (...args)=>_fetch(...args);
};

},{"6148091958f44961":"dQm8Z","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dQm8Z":[function(require,module,exports) {
...
if (typeof globalThis === "object") _globalThis = globalThis;
    ...
    _globalThis = require("8c9e0dc3361e4af3");
} catch (error) {} finally{
    if (!_globalThis && typeof window !== "undefined") _globalThis = window;
    if (!_globalThis) throw new Error("Could not determine global this");
}
var NativeWebSocket = _globalThis.WebSocket || _globalThis.MozWebSocket;
var websocket_version = require("95711c035965f183");
/**
...
},{"8c9e0dc3361e4af3":"i0Mdn","95711c035965f183":"itgdA"}],"i0Mdn":[function(require,module,exports) {
...
module.exports = require("215929862874f9c3").version;

},{"215929862874f9c3":"fCYcm"}],"fCYcm":[function(require,module,exports) {
...
const resolveFetch = (customFetch)=>{
    ...
    if (customFetch) _fetch = customFetch;
            ...
            return yield (yield require("66b3ec44cb246f18")).fetch(...args);
        });
    else _fetch = fetch;
    return (...args)=>_fetch(...args);
};
const resolveResponse = ()=>__awaiter(void 0, void 0, void 0, function*() {
        if (typeof Response === "undefined") return (yield require("66b3ec44cb246f18")).Response;
        return Response;
    });

},{"66b3ec44cb246f18":"dQm8Z","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"caYeW":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _constants = require("../lib/constants");
var _errors = require("../lib/errors");
...
const resolveFetch = (customFetch)=>{
    ...
    if (customFetch) _fetch = customFetch;
            ...
            return yield (yield require("bdfabd064d2be5b4")).fetch(...args);
        });
    else _fetch = fetch;
    return (...args)=>_fetch(...args);
};
...
},{"bdfabd064d2be5b4":"dQm8Z","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bDFnv":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const loadProducts = async function() {
    try {
        const data = await (0, _supabaseJs.supabase).from("product").select("*");
...
const createProductObject = function(data) {
    ...
    data.forEach((product1)=>console.log("test"));
    return {
        id: product.id,
...
},{"./supabase.js":"hCZEc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"knogC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./view");
var _viewDefault = parcelHelpers.interopDefault(_view);
class ProductListView extends (0, _viewDefault.default) {
...
exports.default = new ProductListView();
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["d8XZh","aenu9"], "aenu9", "parcelRequire261d")
